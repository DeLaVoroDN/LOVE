...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const cardTexts = [
    ...
    'С тобой я чувствую себя как дома, в любой точке мира.💖',
    ...
    'Любовь к тебе - это самый прекрасный цветок, который цветет в моем сердце.💖',
    'С тобой я осмеливаюсь мечтать о самых смелых идеях и желаниях.💖',
    'Твоя любовь кажется бесконечной, как само небо, в котором мы плаваем.💖',
